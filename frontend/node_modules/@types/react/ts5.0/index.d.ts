...
declare namespace React {
    ...
    /**
     * Lets you defer loading a component?셲 code until it is rendered for the first time.
     *
     ...
     * resolved value?셲 `.default` as a React component. Both the returned `Promise` and the `Promise`?셲
     ...
     *
     * Note that `useRef()` is useful for more than the `ref` attribute. It?셲 handy for keeping any mutable
     * value around similar to how you?셝 use instance fields in classes.
     *
     * @version 16.8.0
     ...
     *
     * If you?셱e migrating code from a class component, `useLayoutEffect` fires in the same phase as
     ...
     *
     * NOTE: We don?셳 recommend adding debug values to every custom hook.
     * It?셲 most valuable for custom hooks that are part of shared libraries.
     *
     * @version 16.8.0
    ...
    /**
     * Returns a deferred version of the value that may ?쐋ag behind??it.
     *
     ...
     * @param initialValue A value to use during the initial render of a component. If this option is omitted, `useDeferredValue` will not defer during the initial render, because there?셲 no previous version of `value` that it can render instead.
     *
     ...
     *
     * The first is a boolean, React?셲 way of informing us whether we?셱e waiting for the transition to finish.

...
/**
 * Returns an unbiased estimator of the population variance of the given iterable of numbers using Welford?셲 algorithm.
...
export class Adder {
    ...
    /**
     * Adds the specified number to the adder?셲 current value and returns the adder.
     */
    add(number: number): Adder;

    /**
     * Returns the IEEE 754 double precision representation of the adder?셲 current value.
...
/**
 * Randomizes the order of the specified array using the Fisher?밳ates shuffle.
 */

...
export interface GeneratorOptions {
    ...
    /**
     * Set to true to run jsesc with "json": true to print "\u00A9" vs. "짤";
     */
    ...
    jsescOption?: {
         ...
         * environments is a concern, don?셳 enable this setting. If the json setting is enabled, the value for the es6
         ...
         * is escaped as \x3C!-- (or \u003C!-- when the json option is enabled). This setting is useful when jsesc?셲
         ...
         * the output for arrays and objects is as compact as possible; it?셲 not formatted nicely.
         */
         ...
         * overridden if needed ??but in such cases, the output won?셳 be valid JSON anymore.
         */

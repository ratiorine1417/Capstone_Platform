...
declare module "url" {
     ...
     * import url from 'node:url';
     *
     * console.log(url.domainToASCII('espa챰ol.com'));
     * // Prints xn--espaol-zwa.com
     * console.log(url.domainToASCII('訝?뻼.com'));
     * // Prints xn--fiq228c.com
     * console.log(url.domainToASCII('xn--i챰valid.com'));
     ...
     * // Prints 訝?뻼.com
     * console.log(url.domainToUnicode('xn--i챰valid.com'));
     * // Prints an empty string
     * ```
     * @since v7.4.0, v6.13.0
     */
     ...
     *
     * new URL('file:///鵝졾?.txt').pathname;      // Incorrect: /%E4%BD%A0%E5%A5%BD.txt
     * fileURLToPath('file:///鵝졾?.txt');         // Correct:   /鵝졾?.txt (POSIX)
     *
     ...
     * const myURL = new URL('https://a:b@歷цĳ?abc#foo');
     *
    ...
    class URL {
         ...
         *
         * ```js
         * const idnURL = new URL('https://歷цĳ');

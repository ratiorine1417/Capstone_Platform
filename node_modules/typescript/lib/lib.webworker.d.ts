...
/**
 * The **`DOMMatrix`** interface represents 4횞4 matrices, suitable for 2D and 3D operations including rotation and translation.
 *
...
interface DOMMatrix extends DOMMatrixReadOnly {
    ...
    /**
     * The **`multiplySelf()`** method of the DOMMatrix interface multiplies a matrix by the `otherMatrix` parameter, computing the dot product of the original matrix and the specified matrix: `A?꿁`.
     *
...
/**
 * The **`DOMMatrixReadOnly`** interface represents a read-only 4횞4 matrix, suitable for 2D and 3D operations.
 *
